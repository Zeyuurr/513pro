                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="orderonline.php">Products</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12">
                            <h1>
                                ...
                                <span class="d-block text-dark">favorite breads</span>
                            </h1>
                        </div>
                    </div>
                </div>
...
<div id="product-grid">
	...
	?>
		...
		<div class="product-item">
			...
			<a href="http://localhost" id="btnEmpty"
			target="popup"
			onclick="window.open('get-product-info.php?id=<?php echo  $product_array[$key]["id"] ; ?>','popup','width=300,hight=300');return false;">
	...
	?>
    <a href="logout.php" class="btn custom-btn form-control mt-4 mb-3">Log out</a>
