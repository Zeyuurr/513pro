        ...
        <main>
            ...
            <section class="sign-in-form section-padding">
                <div class="container">
                    ...
                    <h1 class="hero-title text-center mb-5">Reset Password</h1>
        <div class="row">
        <div class="col-lg-8 col-11 mx-auto">
            ...
            <p>Please fill out this form to reset your password.</p>
                ...
                <div class="div-separator w-50 m-auto my-5">
                    ...
                    <a class="btn custom-btn form-control mt-4 mb-3"  href="javascript:;" onClick="javascript:history.back(-1);">Cancel</a>
                </div>
            </form>
        </div>
        </div>
